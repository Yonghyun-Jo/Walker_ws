...
#include "p73_msgs/msg/detail/pos_cmd__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const p73_msgs::msg::PosCmd & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  p73_msgs::msg::PosCmd & ros_message)
{
  // Member: position
  {
    cdr >> ros_message.position;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = p73_msgs::msg::PosCmd;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_p73_msgs
max_serialized_size_key_PosCmd(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const p73_msgs::msg::PosCmd *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<p73_msgs::msg::PosCmd *>(
    untyped_ros_message);
...
{
  return &p73_msgs::msg::typesupport_fastrtps_cpp::_PosCmd__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, p73_msgs, msg, PosCmd)() {
  return &p73_msgs::msg::typesupport_fastrtps_cpp::_PosCmd__handle;
}
